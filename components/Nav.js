...
export default function Nav({ show }) {
  ...
  const activeLink = inactiveLink + " bg-white text-[#644930] rounded-md";
  ...
  return (
    <aside
      className={
        ...
        " top-0 text-gray-500  pr-0  text-white fixed w-full bg-[#644930] min-h-screen md:static md:w-auto transition-all"
      }
    >
